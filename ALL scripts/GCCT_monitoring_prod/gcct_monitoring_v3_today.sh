...
#lazy at coding, yesterday will have today's value. Please read accordingly
yesterday_1=`date "+%Y-%m-%d"`
#example date
...
output_tz=`spark-submit --driver-memory 2g GCCT_count_by_date_v3_today.py `
