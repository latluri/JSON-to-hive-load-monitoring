...
all_files=`hadoop fs -ls  /project/dsc/qa/archive/10742_gcctmsd/ | grep ${yesterday_1}| awk -F' +' '{print $8}'|sed 's/$/\/*/g'`
#PID=`hadoop fs -ls  /project/dsc/qa/archive/10742_gcctmsd/ | grep ${yesterday_1}| awk -F' +' '{print $8}'|sed 's/$/\/*/g'| awk -F'/' '{print $7}'`
