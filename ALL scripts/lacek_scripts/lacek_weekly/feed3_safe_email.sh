...
###################################
# ALTER TABLE lacek_fpr.pipe_del_email_safe_cks_current SET TBLPROPERTIES('EXTERNAL'='TRUE');
...
--target-dir  hdfs://hdp2cluster/project/dz/collab/LACEK/lacek_fpr/pipe_del_email_safe_cks_current \
