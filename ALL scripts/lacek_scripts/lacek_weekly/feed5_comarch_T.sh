...
beeline -e "set mapreduce.job.queuename=dz-data-ops;
; INSERT OVERWRITE DIRECTORY '/project/dz/collab/LACEK/lacek_fpr/pipe_del_ncvdg10_fpas_mthly_pt_bal_trend_pii' row format delimited FIELDS TERMINATED BY '|' SELECT * from cvdp.ncvdg10_fpas_mthly_pt_bal_trend_pii
...
; INSERT OVERWRITE DIRECTORY '/project/dz/collab/LACEK/lacek_fpr/pipe_del_ncvdg04_fpas_trn_with_pts_pii' row format delimited FIELDS TERMINATED BY '|' SELECT * from cvdp.ncvdg04_fpas_trn_with_pts_pii 
; INSERT OVERWRITE DIRECTORY '/project/dz/collab/LACEK/lacek_fpr/pipe_del_ncvdg03_fpas_cust_dlr_relshp_pii' row format delimited FIELDS TERMINATED BY '|' SELECT * from cvdp.ncvdg03_fpas_cust_dlr_relshp_pii 
; INSERT OVERWRITE DIRECTORY '/project/dz/collab/LACEK/lacek_fpr/pipe_del_ncvdg02_fpas_uniq_trn_pii' row format delimited FIELDS TERMINATED BY '|' SELECT * from cvdp.ncvdg02_fpas_uniq_trn_pii where cvdpdc_partition_home_cntry_c = 'USA'  AND cvdpdc_trn_cntry_c_2 = 'USA'
